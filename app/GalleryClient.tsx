...
const gallery: GalleryItem[] = [
  {
    ...
    alt: "Community entrance at Parks on Taylor apartments in Sherman TX",
  },
  {
    src: "/webp/gallery/2.webp",
    name: "Courtyard with Mature Landscaping",
    alt: "Landscaped courtyard with greenery at Parks on Taylor Sherman apartments",
  },
  {
    src: "/webp/gallery/3.webp",
    name: "Building Exteriors at Dusk",
    alt: "Apartment building exteriors at sunset Parks on Taylor Sherman TX",
  },
  {
    src: "/webp/gallery/25.webp",
    name: "Private Covered Balcony — Evening",
    alt: "Private covered balcony evening view at Parks on Taylor apartments",
  },

  // ✅ LIVING ROOM (exact text you gave)
  {
    src: "/webp/gallery/10.webp",
    name: "Open-Concept Living Room",
    alt: "Modern open-concept living room at Parks on Taylor apartments Sherman",
  },

  {
    src: "/webp/gallery/5.webp",
    name: "Modern Kitchen with Quartz Countertops",
    alt: "Modern kitchen with quartz countertops in Sherman TX apartment",
  },
  {
    src: "/webp/gallery/2.webp",
    name: "Primary Bedroom — Natural Light",
    alt: "Primary bedroom with natural light at Parks on Taylor apartments Sherman",
  },
  {
    src: "/webp/gallery/15.webp",
    name: "Spa-Inspired Bathroom with Tile Surround",
    alt: "Spa-inspired bathroom with tile surround in Sherman TX apartment",
  },
  {
    src: "/webp/gallery/22.webp",
    name: "Dining Area with Warm Lighting",
    alt: "Dining area with warm lighting at Parks on Taylor apartments",
  },
  {
    src: "/webp/gallery/11.webp",
    name: "Living Room — Floor-to-Ceiling Windows",
    alt: "Living room with floor-to-ceiling windows at Parks on Taylor Sherman",
  },

  // ✅ POOL (exact text you gave)
  {
    src: "/webp/gallery/17.webp",
    name: "Resort-Style Swimming Pool",
    alt: "Resort-style swimming pool and sundeck in Sherman TX apartment community",
  },

  {
    src: "/webp/gallery/29.webp",
    name: "Pool Sundeck with Lounge Seating",
    alt: "Pool sundeck with lounge seating at Parks on Taylor apartments",
  },
  {
    src: "/webp/gallery/25.webp",
    name: "24-Hour Fitness Center",
    alt: "24-hour fitness center at Parks on Taylor apartments Sherman TX",
  },
  {
    src: "/webp/gallery/24.webp",
    name: "Bark Park & Off-Leash Agility Trail",
    alt: "Bark park and off-leash agility trail at Sherman TX apartments",
  },
  {
    src: "/webp/gallery/26.webp",
    name: "Covered Resident Parking",
    alt: "Covered resident parking at Parks on Taylor apartments Sherman TX",
  },
  {
    src: "/webp/gallery/16.webp",
    name: "Historic Downtown Sherman",
    alt: "Historic downtown Sherman Texas near Parks on Taylor apartments",
  },
  {
    src: "/webp/gallery/13.webp",
    name: "Eisenhower State Park Trails",
    alt: "Eisenhower State Park trails near Sherman TX apartments",
  },
  {
    src: "/webp/gallery/18.webp",
    name: "Farm-to-Table Local Dining",
    alt: "Farm-to-table local dining near Parks on Taylor Sherman TX",
  },
  {
    src: "/webp/gallery/28.webp",
    name: "Sherman Saturday Farmers Market",
    alt: "Sherman Saturday Farmers Market near Parks on Taylor apartments",
  },
];
